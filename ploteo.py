...
"""
df_x = pd.DataFrame({'Grid':[1,2,3,4,5], 'Espaciado':[2,1,2,3,0]})
df_y = pd.DataFrame({'Grid':[1,2,3,4,5], 'Espaciado':[2,1,2,3,0]})
df_z = pd.DataFrame({'Grid':[1,2,3,4,5], 'Espaciado':[2,1,2,3,0]})
